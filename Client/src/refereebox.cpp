...
RefereeBox::RefereeBox(QObject *parent) :
    ...
    sendSocket(nullptr){
    ZSS::ZPM::_()->loadParam(_ssl_port,"AlertPorts/SSL_RefereePort",10003);
    ZSS::ZPM::_()->loadParam(_zss_port,"AlertPorts/ZSS_RefereePort",39991);
    ...
    _receiveCmdThread = new std::thread([this] {receiveCommands();});
